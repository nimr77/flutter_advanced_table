...
class AdvancedTableSliver extends StatelessWidget {
          ...
          return SliverMainAxisGroup(
            slivers: [
              if (isLoading)
                ...
                SliverLayoutBuilder(builder: (context, constraints) {
                  ...
                  return SliverToBoxAdapter(
                    child: DefaultTextStyle(
                      ...
                      child: Padding(
                        padding: paddingObjects.add(outterHeaderPadding ??
                ...
                if (items.isEmpty)
                  SliverFillRemaining(child: onEmptyState)
                else
                  SliverLayoutBuilder(builder: (context, constraints) {
                    final actionsLength = (actions?.length ?? 0);
                    final maxWidth = constraints.crossAxisExtent;
                                        ...
                                        child: InkWell(
                                          ...
                                          child: AnimatedContainer(
                                            ...
                                            decoration: rowElementsDecoration ??
                                                rowDecorationBuilder?.call(
                                                    index, isHover),
                                            padding: innerRowElementsPadding,
